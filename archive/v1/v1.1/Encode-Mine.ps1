...
C:\Users\abanta\Downloads\HandBrakeCLI-1.5.1-win-x86_64\HandBrakeCLI.exe --preset-import-gui -Z "Mine" -i "$($mkv.FullName)" --main-feature -o "$($mkv.psdrive.root)Encoded\$($mkv.directory.name)\$($mkv.BaseName).m4v"
If ($?) {
